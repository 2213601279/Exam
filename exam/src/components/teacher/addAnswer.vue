...
<template>
  <div class="exam">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="institute" label="所属单位" width="120"></el-table-column>
      <el-table-column prop="major" label="所属部门" width="200"></el-table-column>
      <el-table-column prop="grade" label="考试年份" width="100"></el-table-column>
